...
public class SearchUserFragment extends BaseFragment implements View.OnClickListener, UserSelectListener {
    ...
    private ArrayList<SearchUserResponseBean.UserData> arrayListUser = new ArrayList<>();
    ...
    Observer<SearchUserResponseBean> observer = new Observer<SearchUserResponseBean>() {
        @Override
        public void onChanged(@Nullable SearchUserResponseBean response) {
            ...
            if (response == null)
                ...
                arrayListUser = response.getResponseData().getData();
    ...
    private void setUserListAdapter(ArrayList<SearchUserResponseBean.UserData> arrayList){
