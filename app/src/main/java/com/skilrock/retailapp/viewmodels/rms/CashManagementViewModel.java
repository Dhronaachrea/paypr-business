...
public class CashManagementViewModel extends ViewModel {
    ...
    private MutableLiveData<CashManagementUserResponseBean> liveDataUser        = new MutableLiveData<>();
    ...
    public MutableLiveData<CashManagementUserResponseBean> getLiveDataUser(){ return liveDataUser; }
    ...
    public void userSearchApi(String url) {
        ...
        Call<CashManagementUserResponseBean> userCall = apiClient.postUserSearch(url, PlayerData.getInstance().getToken(), model);

        Log.d("log", "Cash Management User: " + userCall.request().toString());

        userCall.enqueue(new Callback<CashManagementUserResponseBean>() {
            @Override
            public void onResponse(@NonNull Call<CashManagementUserResponseBean> call, @NonNull Response<CashManagementUserResponseBean> response) {
                if (response.body() == null || !response.isSuccessful()) {
                    if (response.errorBody() != null) {
                        try {
                            ...
                            CashManagementUserResponseBean model;
                            model= gson.fromJson(errorResponse, CashManagementUserResponseBean.class);
            ...
            @Override
            public void onFailure(@NonNull Call<CashManagementUserResponseBean> call, @NonNull Throwable throwable) {
