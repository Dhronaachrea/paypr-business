...
public class AccountSettlementViewModel extends ViewModel {
    ...
    private MutableLiveData<OrgUserResponseBean> liveDataOrgUser = new MutableLiveData<>();
    ...
    public MutableLiveData<OrgUserResponseBean> getLiveDataOrgUser() {
    ...
    public void callGetOrgUserApi(String token, String url, long orgId, long domainId) {
        ...
        final Call<OrgUserResponseBean> paymentReportCall = apiClient.getOrgUser(url, token, searchUserRequestBean);

        Log.d("log", "OrgUser Request : " + paymentReportCall.request().toString());

        paymentReportCall.enqueue(new Callback<OrgUserResponseBean>() {
            @Override
            public void onResponse(@NonNull Call<OrgUserResponseBean> call, @NonNull Response<OrgUserResponseBean> response) {
                if (!response.isSuccessful() || response.body() == null) {
                    if (response.errorBody() != null) {
                        try {
                            ...
                            OrgUserResponseBean model;
                            model = gson.fromJson(errorResponse, OrgUserResponseBean.class);
            ...
            @Override
            public void onFailure(@NonNull Call<OrgUserResponseBean> call, @NonNull Throwable throwable) {
