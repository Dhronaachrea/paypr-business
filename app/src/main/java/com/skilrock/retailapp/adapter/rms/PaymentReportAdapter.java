...
public class PaymentReportAdapter extends RecyclerView.Adapter<PaymentReportAdapter.PaymentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PaymentViewHolder holder, int position) {
        ...
        if (TextUtils.isEmpty(payment.getTxnType())) {
            ...
            holder.tvTitle.setText(String.valueOf(payment.getTxnType().charAt(0)).replace("P","C"));
        ...
        if (TextUtils.isEmpty(payment.getTxnType()))
            ...
            type = context.getString(R.string.type) + " " + payment.getTxnType().replaceAll("(?i)Player","Consumer");
        ...
        if (TextUtils.isEmpty(payment.getTxnBy()))
            ...
            by = context.getString(R.string.by) + " " + payment.getTxnBy().replaceAll("(?i)Player","Consumer");
