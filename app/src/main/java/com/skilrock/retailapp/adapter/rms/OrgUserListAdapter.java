...
public class OrgUserListAdapter extends RecyclerView.Adapter<OrgUserListAdapter.UserViewHolder> {
    ...
    private ArrayList<OrgUserResponseBean.UserData> arrayList;
    private Context context;
    private UserSelectListener userSelectListener;

    public OrgUserListAdapter(ArrayList<OrgUserResponseBean.UserData> listBill, Context context, UserSelectListener userSelectListener) {
