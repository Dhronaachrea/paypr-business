...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.UserViewHolder> {
    ...
    private ArrayList<SearchUserResponseBean.UserData> arrayList;
    private Context context;
    private UserSelectListener userSelectListener;

    public UserListAdapter(ArrayList<SearchUserResponseBean.UserData> listBill, Context context, UserSelectListener userSelectListener) {
    ...
    public void onBindViewHolder(@NonNull UserViewHolder holder, final int position) {
        ...
        holder.tvStatus.setTextColor(arrayList.get(position).getStatus().equalsIgnoreCase("active") ?
                context.getResources().getColor(R.color.colorGreen) : context.getResources().getColor(R.color.colorDue));

        holder.tvStatus.setText(arrayList.get(position).getStatus().equalsIgnoreCase("active") ?
                context.getString(R.string.active) : context.getString(R.string.inactive));

        holder.tvStatus.setBackground(arrayList.get(position).getStatus().equalsIgnoreCase("active") ?
