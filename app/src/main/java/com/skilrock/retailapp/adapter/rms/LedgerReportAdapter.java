...
public class LedgerReportAdapter extends RecyclerView.Adapter<LedgerReportAdapter.PaymentViewHolder> implements AppConstants {
    ...
    public void onBindViewHolder(@NonNull PaymentViewHolder holder, int position) {
        ...
        transaction.setServiceDisplayName(transaction.getServiceDisplayName().replaceAll("(?i)Player","Consumer"));
        transaction.setServiceDisplayName(transaction.getServiceDisplayName().replaceAll("(?i)Retail","Merchant"));
